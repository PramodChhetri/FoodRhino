...
if (!empty($_POST)) {
    ...
    $user = where('users', 'OTTP', '=', $ottp, false);
...
<body style="background-color: #dae8f2">
    <div class="card" style="max-width: 550px; margin:50px auto 50px auto" ;>
        ...
        <div class="card-body">
            <form action="changepasswordstore.php?id=<?php echo $id; ?>" method="POST" enctype="multipart/form-data">
            ...
            <hr>
            <!-- GoTo Login Button -->
            <center><a href="ottp.php"><button class="btn btn-success">Back</button></a></center>
        </div>
    </div>
