        ...
        <div class="col-md-6 col-lg-3" style="padding: 10px;">
            <div class="listing">
                <div class="listing__photo" style="height:150px !important">
                    <a href="restaurant.php?id=15">
                        <img src="images/featured/faip.jpg" style="width:100%;">
                    </a>
                </div>
                <div class="title20 mt-2">
                    <a href="restaurant.php?id=15" style="text-decoration: none; color:white;"><span>Fire And Ice Pizzeria</span></a>
                </div>
            </div>
        </div>
        <div class="col-md-6 col-lg-3" style="padding: 10px;">
            <div class="listing">
                <div class="listing__photo" style="height:150px !important">
                    <a href="restaurant.php?id=16">
                        <img src="images/featured/twe.jpg" style="width:100%;">
                    </a>
                </div>
                <div class="title20 mt-2">
                    <a href="restaurant.php?id=16" style="text-decoration: none; color:white;"><span>The Workshop Eatery</span></a>
                </div>
            </div>
        </div>
        <div class="col-md-6 col-lg-3" style="padding: 10px;">
            <div class="listing">
                <div class="listing__photo" style="height:150px !important">
                    <a href="restaurant.php?id=17">
                        <img src="images/featured/cf.jpeg" style="width:100%;">
                    </a>
                </div>
                <div class="title20 mt-2">
                    <a href="restaurant.php?id=17" style="text-decoration: none; color:white;"><span>Cafe Soma</span></a>
                </div>
            </div>
        </div>
        <div class="col-md-6 col-lg-3" style="padding: 10px;">
            <div class="listing">
                <div class="listing__photo" style="height:150px !important">
                    <a href="restaurant.php?id=18">
                        <img src="images/featured/mdd.jpg" style="width:100%;">
                    </a>
                </div>
                <div class="title20 mt-2">
                    <a href="restaurant.php?id=18" style="text-decoration: none; color:white;"><span>Mittraan Da Dhaba</span></a>
                </div>
            </div>
        </div>
        <div class="col-md-6 col-lg-3" style="padding: 10px;">
            <div class="listing">
                ...
                <div class="title20 mt-2">
                    <a href="restaurant.php?id=19" style="text-decoration: none; color:white;"><span>Le Trio</span></a>
                </div>
            </div>
        </div>
        <div class="col-md-6 col-lg-3" style="padding: 10px;">
            <div class="listing">
                ...
                <div class="title20 mt-2">
                    <a href="restaurant.php?id=20" style="text-decoration: none; color:white;"><span>Pizza Inn</span></a>
                </div>
            </div>
        </div>
        <div class="col-md-6 col-lg-3" style="padding: 10px;">
            <div class="listing">
                ...
                <div class="title20 mt-2">
                    <a href="restaurant.php?id=21" style="text-decoration: none; color:white;"><span>Zhong Hua</span></a>
                </div>
            </div>
        </div>
        <div class="col-md-6 col-lg-3" style="padding: 10px;">
            <div class="listing">
                ...
                <div class="title20 mt-2">
                    <a href="restaurant.php?id=22" style="text-decoration: none; color:white;"><span>Bricks Cafe Firewood Pizza</span></a>
                </div>
            </div>
        </div>
    </div>
