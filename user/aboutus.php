...
if (!empty($_POST)) {
    ...
    header("Location: /foodrhino/user/aboutus.php?id=$rid");
    die;
}
            ...
            <body id="page-top">
                ...
                <div id="wrapper">
                    ...
                    <ul class="navbar-nav  sidebar sidebar-dark accordion" style="background-color: #eb6864;" id="accordionSidebar">
                        ...
                        <!-- Nav Item - UserList -->
                        <li class="nav-item active">
                            <a class="nav-link" href="/foodrhino/user/yourorders.php?id=<?php echo $restaurant['ID'] ?>">
                                <i class="fas fa-fw fa-book"></i>
                                <span>Order</span></a>
                        </li>
                    ...
                    <div>
                        ...
                        <br>
                        <div class="container">
                            <form class="form" action="aboutus.php?id=<?php echo $id ?>" method="POST">
                                <div class="mb-3">
