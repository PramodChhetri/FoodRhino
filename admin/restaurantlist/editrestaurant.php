...
<div class="card" style="max-width: 550px; margin:50px auto 50px auto" ;>
    ...
    <div class="card-body">
        <form action="updaterestaurant.php?id=<?php echo $id; ?>" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <select name="active" class="form-control">
                    <option value="Inactive" <?php if ($restaurant['Active'] == "Inactive") {
                                                    echo "selected";
                                                }; ?>>Inactive</option>
                    <option value="Active" <?php if ($restaurant['Active'] == "Active") {
                                                echo "selected";
                                            }; ?>>Active</option>
                </select>
            </div>
