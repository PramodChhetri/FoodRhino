...
<div class="container" style="margin-bottom: 60px;margin-top: 40px;">
    <div class="row">
        <div style="margin-bottom: 10px;">
            ...
            <a href="allrestaurant.php" style="text-decoration: none; float: right; color:  #eb6864;"><b>View All</b></a>
        </div>
        <div class="col-md-6 col-lg-3" style="padding: 10px;">
            <div class="listing">
                ...
                <div class="title20 mt-2">
                    <a href="restaurant.php?id=15" style="text-decoration: none; color:black;"><span>Fire And Ice Pizzeria</span></a>
                </div>
            </div>
        </div>
        <div class="col-md-6 col-lg-3" style="padding: 10px;">
            <div class="listing">
                ...
                <div class="title20 mt-2">
                    <a href="restaurant.php?id=16" style="text-decoration: none; color:black;"><span>The Workshop Eatery</span></a>
                </div>
            </div>
        </div>
        <div class="col-md-6 col-lg-3" style="padding: 10px;">
            <div class="listing">
                ...
                <div class="title20 mt-2">
                    <a href="restaurant.php?id=17" style="text-decoration: none; color:black;"><span>Cafe Soma</span></a>
                </div>
            </div>
        </div>
        <div class="col-md-6 col-lg-3" style="padding: 10px;">
            <div class="listing">
                ...
                <div class="title20 mt-2">
                    <a href="restaurant.php?id=18" style="text-decoration: none; color:black;"><span>Mittraan Da Dhaba</span></a>
                </div>
            </div>
        </div>
        <div class="col-md-6 col-lg-3" style="padding: 10px;">
